...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'public'), // FIX: use public so preview is accessible via /storage (was private/livewire-tmp -> no preview, green/gray)
